...
public class Keeper extends Subsystem {
    ...
    private final DigitalInput keeperLimit1 = RobotMap.keeperKeeperLimit1;
    private final DigitalInput keeperLimit2 = RobotMap.keeperKeeperLimit2;
    ...
    // This function is deprecated and kept only for reference purposes.
    ...
    public boolean hasBall() {
    	Robot.keeperSwitch = keeperLimit1.get();
    	return Robot.keeperSwitch;
    }
}
