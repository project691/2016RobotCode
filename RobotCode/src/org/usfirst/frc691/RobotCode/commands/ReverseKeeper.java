...
// COMMAND FUNCTION: REVERSE THE GATEKEEPER

public class ReverseKeeper extends Command {
    ...
    protected void initialize() {
    	// Calls the reverseKeeper() function from the keeper
    	// class. Runs the keeper until the command ends.
