...
// COMMAND FUNCTION: INTAKE A BOULDER
...
public class RunIntake extends Command {
    ...
    protected void execute() {
    	...
    	// If it is, the reverseIntake() function is called
    	// from the intake class. If it is not, the
    	// runIntake() function is called from the intake class.
    	// Runs the intake until the command ends.
    ...
    protected void end() { 	
    	// Calls the stopIntake() and stopKeeper() functions
    	// from the intake and keeper classes. Stops the intake
    	// and keeper.
