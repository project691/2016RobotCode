...
// COMMAND FUNCTION: LOB THE BOULDER INTO THE ROBOT

public class DownLob extends Command {
    ...
    protected void initialize() {
    	// Calls the runKeeper(), downShooter(), and reverseIntake()
