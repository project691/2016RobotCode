...
public class RunDrive extends Command {
    ...
    protected void execute() {
    	...
    	Robot.driveTrain.takeJoystickInput(Robot.oi.getJoystick1(), Robot.oi.getJoystick2());
    }
    ...
    protected void end() {
    	// Calls the stop() function from the driveTrain
    	// class. Stops the drivetrain.
